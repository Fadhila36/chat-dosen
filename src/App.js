...
const TimeReminder = () => {
    ...
    const [penutupMuslim, setPenutupMuslim] = React.useState({
        status: true,
        value: 'Wassalamualaikum'
    });
    ...
    const handleChange = (event) => {
        if (event.target.name === "nomor dosen") {
        ...
        } else if (event.target.name === "penutup muslim") {
            ...
            setAdalahPria(prevstate => ({
                ...
                value: (adalahPria.status) ? 'bu' : 'pak'
            }));
    ...
    const handleHour = () => {
        ...
        setRightTime(prevState => ({
            ...prevState,
            status: (currentHour > 9 && currentHour < 20) ? true : false,
                    ...
                    <Grid container direction="row" justify="space-around" alignItems="flex-start" spacing={6}>
                        ...
                        <Grid item sm={12} md={6}>
                            <FormGroup>
                                ...
                                <TextField className={classes.inputText} id="outlined-basic" name="nim" label="Masukan nim anda" variant="outlined" onChange={handleChange} value={nim} />
                                <TextField className={classes.inputText} id="outlined-basic" name="prodi" label="Dari prodi apa" variant="outlined" onChange={handleChange} value={prodi} />
                                ...
                                <FormControlLabel
                                    className={classes.inputText}
                                    // value="start"
                                    label="Gunakan salam penutup untuk Muslim"
                                    labelPlacement="start"
                                    control={
                                        <Switch
                                            color="secondary"
                                            checked={penutupMuslim.status}
                                            onChange={handleChange}
                                            name="penutup muslim"
                                            value={penutupMuslim.value}
                                        />
                                    }
                                />
                        ...
                        <Typography className={classes.footerText} variant="caption" color="textSecondary" align="center">
                        Develop by Fadhila Departemen Pendidikan, Riset, dan Teknologi
                                </Typography>
                    </Grid>
